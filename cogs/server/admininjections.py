...
class GameIniAdminManager(commands.Cog):
    ...
    @nextcord.slash_command(description="Remove admin from the server.", default_member_permissions=nextcord.Permissions(administrator=True), dm_permission=False)
